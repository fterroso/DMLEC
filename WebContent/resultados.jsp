...
<title>Docker Machine Learning Creator</title>
	...
	<%
		...
		String cadenaAyuda = "Gracias por usar Herramienta para la Gestión Automática de Entornos de \n " + 
				...
				"Dentro de esa carpeta encontrará un archivo de ayuda para inspeccionar el contenedor correspondiente a la Base de Datos \n"+
				"*****************************************************\n"+
				"También se habrá generado una carpeta con el IDE seleccionado \n "+
				"En esa carpeta encontrará un archivo Dockerfile y el archivo subido en el servidor. \n"+
				"Si ha creado las imágenes automáticamente introduzca el siguiente comando para desplegar el IDE visualmente: \n"+
				"docker container run --net=host --env=\"DISPLAY=${HOSTNAME}:0\" --volume=\"$HOME/.Xauthority:/root/.Xauthority:rw\" dockeruserucam/docker-ml-creator:TAG-IMAGEN-CORRESPONDIENTE \n"+
				"*****************************************************\n"+
				"*****************************************************\n"+
				"*****************************************************\n"+
				"DOCKER MACHINE LEARNING ENVIRONMENT CREATOR (DMLEC)\n"+
				"*****************************************************\n"+
				" \n"+
				"*****************************************************\n"+
				"Design by Adrián Hernández\n"+
				"*****************************************************\n";
	...
	<%
		...
		if (data.equals("Black Friday")) {
			...
			if (bbdd.equals("MySql")) {
				...
				String lineAy = "Para inpeccionar el contenedor con la base de datos "+
						"debemos de realizar una serie de pasos:\n"+
						"++++++++++++++++++++++++++++++++++++++++++++++++++++\n"+
						"1- $docker build -t dockeruserucam/docker-ml-creator:bdmysql 'ruta donde se encuentra nuestro Dockerfile generado' \n"+
						"en mi caso sería 1- $docker build -t dockeruserucam/docker-ml-creator:bdmysql /Users/adrianhm91/git/DockerCreator/DockerProject/DATOS/MySql/ \n "+
						"*****************************************************\n"+
						"2- $docker run -d --rm --name ContenedorMySql dockeruserucam/docker-ml-creator:bdmysql "+
						"*****************************************************\n"+
						"3- $docker run -it --rm --link ContenedorMySql dockeruserucam/docker-ml-creator:bdmysql mysql -h ContenedorMySql -uroot -proot BlackFriday -e \"select * from BlackFriday;\" \n"+
						"o 4- $docker run -it dockeruserucam/docker-ml-creator:bdmysql bash \n"+
						"*****************************************************\n";
			...
			if (bbdd.equals("PostgreSQL")) {
				...
				String lineAy = "Para inpeccionar el contenedor con la base de datos "+
						"debemos de realizar una serie de pasos:\n"+
						"++++++++++++++++++++++++++++++++++++++++++++++++++++\n"+
						"1- $docker build -t dockeruserucam/docker-ml-creator:bdpostgre 'ruta donde se encuentra nuestro Dockerfile generado' \n"+
						"en mi caso sería 1- $docker build -t dockeruserucam/docker-ml-creator:bdpostgre /Users/adrianhm91/git/DockerCreator/DockerProject/DATOS/PostgreSQL/ \n "+
						"*****************************************************\n"+
						"2- $docker run -d --rm --name ContenedorPostgreSQL dockeruserucam/docker-ml-creator:bdpostgre "+
						"*****************************************************\n"+
						"3- $docker run -it --rm --link ContenedorPostgreSQL dockeruserucam/docker-ml-creator:bdpostgre postgresql -h ContenedorPostgreSQL -uroot -proot BlackFriday -e \"select * from BlackFriday;\" \n"+
						"o 4- $docker run -it dockeruserucam/docker-ml-creator:bdpostgre bash \n"+
						"*****************************************************\n";
			...
			if (bbdd.equals("MariaDB")) {
				...
				String lineAy = "Para inspeccionar el contenedor con la base de datos"+
				"debemos de realizar una serie de pasos:\n"+
				"++++++++++++++++++++++++++++++++++++++++++++++++++++\n"+
				"1- $docker build -t dockeruserucam/docker-ml-creator:bdmaria 'ruta donde se encuentra nuestro Dockerfile generado' \n"+
				"en mi caso sería 1- $docker build -t dockeruserucam/docker-ml-creator:mariadb /Users/adrianhm91/git/DockerCreator/DockerProject/DATOS/MariaDB/ \n "+
				"*****************************************************\n"+
				"2- $docker run -d --rm --name ContenedorMariaDB dockeruserucam/docker-ml-creator:bdmaria "+
				"*****************************************************\n"+
				"3- $docker run -it --rm --link ContenedorMariaDB dockeruserucam/docker-ml-creator:mariadb mysql -h ContenedorMariaDB -uroot -proot BlackFriday -e \"select * from BlackFriday;\" \n"+
				"o 4- $docker run -it dockeruserucam/docker-ml-creator:bdmaria bash \n"+
				"*****************************************************\n";
	...
	<%
			...
			if (bbdd.equals("MySql")) {
				...
				String lineAy = "Para inspeccionar el contenedor con la base de datos "+
						...
						"2- $docker run -d --rm --name ContenedorMySql dockeruserucam/docker-ml-creator:bdmysql "+
						"*****************************************************\n"+
						"3- $docker run -it --rm --link ContenedorMySql dockeruserucam/docker-ml-creator:bdmysql mysql -h ContenedorMySql -uroot -proot StudentsPerformance -e \"select * from StudentsPerformance;\" \n"+
						"o 4- $docker run -it dockeruserucam/docker-ml-creator:bdmysql bash \n"+
						"*****************************************************\n";
			...
			if (bbdd.equals("PostgreSQL")) {
				...
				String lineAy = "Para inspeccionar el contenedor con la base de datos"+
						...
						"2- $docker run -d --rm --name ContenedorPostgreSQL dockeruserucam/docker-ml-creator:bdpostgre "+
						"*****************************************************\n"+
						"3- $docker run -it --rm --link ContenedorPostgreSQL dockeruserucam/docker-ml-creator:bdpostgre postgresql -h ContenedorPostgreSQL -uroot -proot StudentsPerformance -e \"select * from StudentsPerformance;\" \n"+
						"o 4- $docker run -it dockeruserucam/docker-ml-creator:bdpostgre bash \n"+
						"*****************************************************\n";
			...
			if (bbdd.equals("MariaDB")) {
				...
				"++++++++++++++++++++++++++++++++++++++++++++++++++++\n"+
				"1- $docker build -t dockeruserucam/docker-ml-creator:bdmaria 'ruta donde se encuentra nuestro Dockerfile generado' \n"+
				"en mi caso sería 1- $docker build -t dockeruserucam/docker-ml-creator:bdmaria /Users/adrianhm91/git/DockerCreator/DockerProject/DATOS/MariaDB/ \n "+
				"*****************************************************\n"+
				"2- $docker run -d --rm --name ContenedorMariaDB dockeruserucam/docker-ml-creator:bdmaria "+
				"*****************************************************\n"+
	...
	<%
			...
			if (bbdd.equals("MySql")) {
				...
				String lineAy = "Para inspeccionar el contenedor con la base de datos"+
						...
						"2- $docker run -d --rm --name ContenedorMySql dockeruserucam/docker-ml-creator:bdmysql "+
						"*****************************************************\n"+
						"3- $docker run -it --rm --link ContenedorMySql dockeruserucam/docker-ml-creator:bdmysql mysql -h ContenedorMySql -uroot -proot GooglePlay -e \"select * from GooglePlay;\" \n"+
						"o 4- $docker run -it dockeruserucam/docker-ml-creator:bdmysql bash \n"+
						"*****************************************************\n";
			...
			if (bbdd.equals("PostgreSQL")) {
				...
				String lineAy = "Para inspeccionar el contenedor con la base de datos"+
						...
						"2- $docker run -d --rm --name ContenedorPostgreSQL dockeruserucam/docker-ml-creator:bdpostgre "+
						"*****************************************************\n"+
						"3- $docker run -it --rm --link ContenedorPostgreSQL dockeruserucam/docker-ml-creator:bdpostgre mysql -h ContenedorPostgreSQL -uroot -proot GooglePlay -e \"select * from GooglePlay;\" \n"+
						"o 4- $docker run -it dockeruserucam/docker-ml-creator:bdpostgre bash \n"+
						"*****************************************************\n";
			...
			if (bbdd.equals("MariaDB")) {
				...
				"2- $docker run -d --rm --name ContenedorMariaDB dockeruserucam/docker-ml-creator:bdmaria "+
				"*****************************************************\n"+
				"3- $docker run -it --rm --link ContenedorMariaDB dockeruserucam/docker-ml-creator:bdmaria mysql -h ContenedorMariaDB -uroot -proot GooglePlay -e \"select * from GooglePlay;\" \n"+
				"o 4- $docker run -it dockeruserucam/docker-ml-creator:bdmaria bash \n"+
				"*****************************************************\n";
