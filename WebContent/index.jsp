		...
		<div class="main-agileinfo">
			...
			<p>Formulario de conexión con ApiDocker </p>
				...
				<form action="form.jsp" method="post" id="formIndex">
					<input class="text" type="email"  name="MAIL" placeholder="Email de cuenta Docker" required>
					<input class="text email" type="password"  name="PASS" placeholder="Contraseña de cuenta Docker" required>
					<input class="text email" type="text"  name="USERNAME" placeholder="Nombre usuario de Docker" required>
					<input class="text email" type="text" name="CERTS" placeholder="Ruta de certificados Docker" required >
			...
			<i class="fa fa-info"></i>
					...
					<input class="text" type="text" name="CONF" placeholder="Ruta de ficheros de configuración Docker" required>
					...
					<input type="submit" class="main-agileinfo-btn"  value="SIGUIENTE">
				</form>
			</div>
